...
//
//
// class GetTenantCompletedComplainsUseCase implements UseCase<Either<String, ComplainResponseModel>, GetComplainsParams> {
//   @override
...
//       return await sl<ComplainsRepository>().getTenantCompletedComplains(param);
//     } catch (e) {
